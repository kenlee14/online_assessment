...
<?php
				    ...
				    $qid=$_REQUEST['qid'];
				    $query=mysqli_query($con,"select * from quiz where quiz_id='$qid'")or die(mysqli_error());
		...
		$qid=$_REQUEST['qid'];
		$query=mysqli_query($con,"select * from question where quiz_id='$qid'")or die(mysqli_error());
