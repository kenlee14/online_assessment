...
include('dbcon.php');
	...
	$query=mysqli_query($con,"select * from member where member_last='$last' and member_first='$first'")or die(mysqli_error());
		...
		{
		mysqli_query($con,"INSERT INTO member(member_last,member_first,email,member_pic,member_type) VALUES('$last','$first','$email','default.gif','Faculty')")or die(mysqli_error());  
